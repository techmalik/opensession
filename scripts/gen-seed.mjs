...
const main = async () => {
  ...
  const tables = [
    "users","events","contacts","event_contacts","tracks","formats","levels","tags","rooms","statuses","forms","form_fields","sessions","session_participants","session_tags","eval_plans","eval_criteria","eval_plan_reviewers","eval_assignments","eval_scores","ai_reviews","portal_tasks","task_completions","file_requests","file_uploads","file_comments","email_templates","email_sends","jobs","airtable_links","api_tokens","settings",
  ];
